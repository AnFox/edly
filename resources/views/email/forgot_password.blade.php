                            ...
                            <tr style="border-collapse:collapse;">
                                <td align="left" bgcolor="#ffffff"
                                    style="padding:0;Margin:0;"><p
                                        ...
                                        <strong><span
                                                    style="font-size:36px;line-height:54px;">Сброс пароля<br/></span></strong><br><br><span
                                                style="font-size:18px;line-height:27px;">Здравствуйте, {{ $username }}!<br><br>Для сброса пароля к вашей учетной записи в сервисе Edly необходимо перейти по ссылке или нажать кнопку.</span>
                                    </p></td>
                            </tr>
                        </table>
                    </td>
                            ...
                            <tr style="border-collapse:collapse;">
                                <td align="left" style="padding:0;Margin:0;"><p
                                        ...
                                        <a href="{{ $resetLink }}" target="_blank"
                                           style="text-decoration: none;color:#222B45"><strong>{{ $resetLink }}</strong>
                                        </a>
                                    </p>
                                </td>
                            </tr>
                            ...
                            <tr style="border-collapse:collapse;">
                                <td align="left" style="padding:10px;Margin:0;"><span
                                            ...
                                            style="margin-bottom: 40px;border-style:solid;background:linear-gradient(0deg, #3366FF 0%, #598BFF 100%);border-width:0px 0px 2px 0px;display:inline-block;border-radius:30px;width:auto;border-bottom-width:0px;"><a
                                                href="{{ $resetLink }}" class="es-button"
                                                target="_blank"
