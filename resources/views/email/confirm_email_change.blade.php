                            ...
                            <tr style="border-collapse:collapse;">
                                <td align="left" bgcolor="#ffffff"
                                    style="padding:0;Margin:0;"><p
                                        ...
                                        <strong><span
                                                    style="font-size:36px;line-height:54px;">Смена Email<br/></span></strong><br><br>
                                        <span
                                                style="font-size:18px;line-height:27px;">
                                            Здравствуйте!<br>
                                            <br>Вы запросили смену Email в сервисе Edly.
                                            <br>Для подтверждения нового адреса почты необходимо перейти по ссылке или нажать кнопку.
                                        </span>
                                    </p></td>
                            </tr>
                        </table>
