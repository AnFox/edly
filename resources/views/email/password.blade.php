                            ...
                            <tr style="border-collapse:collapse;">
                                <td align="left" bgcolor="#ffffff"
                                    style="padding:0;Margin:0;"><p
                                        ...
                                        <strong>
                                            <span style="font-size:36px;line-height:54px;">Подтверждение регистрации<br/></span></strong><br><br>
                                        <span style="font-size:18px;line-height:27px;">
                                            Здравствуйте!<br><br>Вы успешно зарегистрировались в сервисе Edly.
                                        </span>
                                        <span style="font-size:18px;line-height:27px;">
